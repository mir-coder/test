...
/* ТАЙМЕР ОБРАТНОГО ОТСЧЕТА */
    ...
    class CountdownTimer {
      ...
      document.addEventListener('DOMContentLoaded', () => {
        ...
        new CountdownTimer(deadline1, (timer) => {
          ...
          document.querySelector('.timer .timer__result').textContent = 'Таймер завершился!';
        });
  ...
  /* ВВОД В INPUT ТОЛЬКО ЦИФРЫ */
  
  document.oninput = function() {
    var input = document.querySelector('.order-form__form-number');
